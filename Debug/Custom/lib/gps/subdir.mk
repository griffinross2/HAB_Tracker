...
OBJS += \
./Custom/lib/gps/max_m10s.o 

C_DEPS += \
./Custom/lib/gps/max_m10s.d 


# Each subdirectory must supply rules for building sources it contributes
Custom/lib/gps/%.o Custom/lib/gps/%.su Custom/lib/gps/%.cyclo: ../Custom/lib/gps/%.c Custom/lib/gps/subdir.mk
...
clean: clean-Custom-2f-lib-2f-gps

clean-Custom-2f-lib-2f-gps:
	-$(RM) ./Custom/lib/gps/max_m10s.cyclo ./Custom/lib/gps/max_m10s.d ./Custom/lib/gps/max_m10s.o ./Custom/lib/gps/max_m10s.su

.PHONY: clean-Custom-2f-lib-2f-gps
